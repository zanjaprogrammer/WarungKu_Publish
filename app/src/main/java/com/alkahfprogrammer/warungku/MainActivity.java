...
import com.alkahfprogrammer.warungku.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        com.alkahfprogrammer.warungku.utils.StockNotificationHelper notificationHelper = 
            new com.alkahfprogrammer.warungku.utils.StockNotificationHelper(this);
        ...
        new androidx.appcompat.app.AlertDialog.Builder(this)
                ...
                .setPositiveButton("Simpan", (dialog, which) -> {
                    ...
                    if (!desc.isEmpty() && !sPrice.isEmpty()) {
                        ...
                        com.alkahfprogrammer.warungku.data.entity.CashFlow flow = new com.alkahfprogrammer.warungku.data.entity.CashFlow(
                                "OUT", price, desc,
